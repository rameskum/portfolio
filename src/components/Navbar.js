        ...
        <nav className="nav" id="nav">
            <div className="nav-center">
                <div className="nav-header">
                    <svg className="nav-logo" fill="none" viewBox="0 0 84 96" xmlns="http://www.w3.org/2000/svg">
                        <g id="logo">
                            <g id="Group">
                                <g id="Group_2">
                                    <path d="M42 3L3 25V70L42 93L81 71V26L42 3Z" id="Shape" strokeLinecap="round"
