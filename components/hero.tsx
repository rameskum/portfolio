    ...
    <section className="px-6 md:px-12 py-16 md:py-24">
      <div className="max-w-6xl mx-auto">
        <div className="relative overflow-hidden">
          {/* backdrop artwork — desktop only, stays inside the intro block */}
          <div
            aria-hidden="true"
            className="absolute right-0 top-1/2 -translate-y-1/2 w-[540px] max-w-[45%] hidden md:block pointer-events-none [mask-image:linear-gradient(to_right,transparent,black_30%)]"
          >
            <Image
